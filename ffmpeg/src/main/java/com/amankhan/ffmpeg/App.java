...
import com.amankhan.youtubedl_android.BuildConfig;
import com.amankhan.youtubedl_android.YoutubeDL;
import com.amankhan.youtubedl_android.YoutubeDLException;
    ...
    public void onCreate() {
        ...
        Completable.fromAction(this::initLibraries).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe(new DisposableCompletableObserver() {
            ...
            public void onError(Throwable e) {
                ...
                Toast.makeText(getApplicationContext(), "initialization failed: " + e, Toast.LENGTH_SHORT).show();
            }
        });
    }
